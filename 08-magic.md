...
force, such as the wall created by
 _wall of force._
...
be restored to life only by means of a
 _true
resurrection_ or a
 _wish_ spell.
...
creatures.
**_Dismissal._** As your action, make a melee spell
...
**_At Higher Levels._** When you cast this spell with a
9th- level spell slot, the duration is concentration, up
to 8 hours.

#### Dominate Person

_5th- level enchantment
_
...
**_Structures._** The tremor deals 50 bludgeoning
...
once.
**_Enlarge._** The target's size doubles in all
...
extra damage.
**_Reduce._** The target's size is halved in all
...
on a saving throw against this casting of
 _eyebite._
**_Asleep._** The target falls unconscious. It wakes up if
it takes any damage or if another creature uses its
action to shake the sleeper awake.
**_Panicked._** The target is frightened of you. On each
...
Whi le your familiar is within 100 feet of you, you
...
runes_ or a
 _spell glyph._
**_Explosive Runes._** When triggered, the glyph
...
one.
**_Spell Glyph._** You can store a prepared spell of 3rd
...
_explosive runes_ glyph increases by 1d8 for each slot
level above 3rd. If you create a
 _spell glyph_ , you can
...
_Guards and wards_ creates the following effects
within the warded area.
**_Corridors._** Fog fills all the warded corridors,
...
```
- Place
 _dancing lights_ in four corridors. You can
 designate a simple program that the lights repeat
 as long as
 _guards and wards_ lasts.
- Place
 _magic mouth_ in two locations.
- Place
 _stinking cloud_ in two locations. The vapors
 appear in the places you designate; they return
 within 10 minutes if dispersed by wind while
 _guards and wards_ lasts.
- Place a constant
 _gust of wind_ in one corridor or
 room.
- Place a
 _suggestion_ in one location. You select an
 ...
 _dispel
magic_ cast on a specific effect, if successful, removes
only that effect.
...
an area already under the effect a
 _hallow_ spell. The
...
char med, frightened, or possessed by such a
...
Range: Touch
Components:
 V, S, M (a pearl worth at least 100 gp
and an owl feather)
Duration:
 Instantaneous
```
...
A
 _dispel magic_ spell can end the spell only if it is
...
ker nels of grain, and a smear of fat)
**Duration:** Concentration, up to 10 minutes
...
Range: Touch
Components:
 V, S, M (an eyelash encased in gum
arabic)
Duration: Concentration, up to 1 hour
...
**Range:** Touch
**Components:
** V, M (a firefly or phosphorescent
moss)
**Duration:** 1 hour
...
lea d, even a thin sheet, blocks a direct path between
you and the object.
...
by a
 _protection from evil and good_ or
 _magic circle_
...
foils
 wish spells and spells or effects of similar power
...
A
 _remove curse_ or
 _greater restoration_ spell cast on
the target restores the creature's true memory.
**_At Higher Levels_** . If you cast this spell using a spell
...
For the duration, each creature you choose within
 30
...
summoned into the center of an inverted
 magic
...
duration of the spell. A
 _rod of cancellation_ destroys a
_prismatic wall_ , but an
 _antimagic field_ has no effect on
it.
**_1. Red._** The creature takes 10d6 fire damage on a
failed save, or half as much damage on a successful
...
a
 dispel magic spell or a similar spell of equal or
...
- Nothing can teleport into or out of the warded
 area.
- Pla nar travel is blocked within the warded area.
...
A
 _disintegrate_ spell targeting the globe destroys it
...
sen sors created by divination spells.
...
**Casting Time:** 1 reaction, which you take when you
are hit by an attack or targeted by the
 _magic
missile_ spell
**Range:** Self
**Components:** V, S
...
**Range:** 60 feet
**Components:
** V, S, M (a small parchment with a bit
of
...
**Range:** 90 feet
**Components:
** V, S, M (a pinch of fine sand, rose
petals, or a cricket)
...
gain s the ability to move up, down, and across
...
Duration: Concentration, up to 1 minute
You create a
 20 -foot-radius sphere of yellow,
...
tha t light must make a Constitution saving throw. On
...
**_Discord._** Each target must make a Constitution
...
checks.
**_Fear._** Each target must make a Wisdom saving
...
**_Hopelessness._** Each target must make a Charisma
...
**_Insanity._** Each target must make an Intelligence
...
**_Pain._** Each target must make a Constitution saving
throw and becomes incapacitated with excruciating
pain for 1 minute on a failed save.
**_Sleep._** Each target must make a Wisdom saving
...
**_Stunning._** Each target must make a Wisdom
...
spell.
**_Creature._** You can try to move a Huge or smaller
...
01- 50
 ...
 -- --
```
**_Familiarity._** "Permanent circle" means a
...
**_On Target._** You and your group (or the target
...
dispel magic. A
 disintegrate spell destroys the wall
...
Range: Touch
Components:
 V, S, M (a pair of platinum rings worth
...
_Wish_ is the mightiest spell a mortal creature can cast.
...
chance that you are unable to cast
 wish ever again if
